...
export default function FilesPage() {
  ...
  const [logout] = useGlobalStore((state) => [state.authActions.logout])
    ...
    <div className="ml-64 p-6 w-full">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="bg-blue-500 text-white px-6 py-2 rounded-lg cursor-pointer hover:bg-blue-600 transition-colors shadow-md hover:shadow-lg"
        >
